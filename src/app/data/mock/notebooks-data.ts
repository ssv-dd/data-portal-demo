...
export const mockNotebooks: Notebook[] = [
  ...
  { id: '2', title: 'DashPass Retention Deep-Dive', description: 'Cohort analysis of DashPass subscriber retention', lastEdited: '5 hours ago', owner: appConfig.user.name, shared: true, cells: 18, language: 'Python' },
  ...
  { id: '4', title: 'Delivery Time Optimization', description: 'Analysis of delivery time factors and bottlenecks', lastEdited: '2 days ago', owner: appConfig.user.name, shared: false, cells: 16, language: 'Python' },
  ...
  { id: '6', title: 'Ad Attribution Model', description: 'Multi-touch attribution for marketing campaigns', lastEdited: '4 days ago', owner: appConfig.user.name, shared: false, cells: 20, language: 'Python' },
];
