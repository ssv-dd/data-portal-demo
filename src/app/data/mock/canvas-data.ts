...
export const mockCanvases: Canvas[] = [
  ...
  },
  {
    ...
    description: 'Top-line company metrics: GOV, Revenue, MAU, Contribution Margin',
    lastEdited: '1 day ago',
    metrics: 11,
    owner: 'S&O Leadership',
    shared: true,
    golden: true,
    externalUrl: appConfig.externalUrls.companyDashboard,
  },
  {
    id: '8',
    title: "Progress vs Plan Q1'26",
    description: 'QTD performance vs AOP across all product areas',
    lastEdited: '3 days ago',
    metrics: 14,
    owner: 'BizOps',
    shared: true,
    golden: true,
    externalUrl: appConfig.externalUrls.progressVsPlan,
  },
  {
    id: '9',
    title: 'CPD Projector',
    description: 'Customer Performance Dashboard with projections and forecasts',
    lastEdited: '1 week ago',
    metrics: 20,
    owner: 'Consumer Analytics',
    shared: true,
    golden: true,
    externalUrl: appConfig.externalUrls.cpdProjector,
  },
];
