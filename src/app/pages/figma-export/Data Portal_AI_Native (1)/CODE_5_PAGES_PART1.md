# Page Components Part 1 - Complete Source Code

This file contains the main page components (home, my-canvas, sql-studio).

---

## src/app/pages/home-page.tsx

**⚠️ IMPORTANT:** Replace `figma:asset` imports with real image URLs before using in Cursor.

See the current `/src/app/pages/home-page.tsx` file - it's the largest file with complex animations.

For Cursor, replace lines 9-13:
```tsx
// BEFORE (Figma Make only):
import analysisImage1 from 'figma:asset/d6b9d1d8fdb529e192abe6751b36c052d614bcb5.png';

// AFTER (for Cursor):
const analysisImage1 = 'https://via.placeholder.com/800x400/FF3A00/FFFFFF?text=Analysis+1';
const analysisImage2 = 'https://via.placeholder.com/800x400/FF3A00/FFFFFF?text=Analysis+2';
const analysisImage3 = 'https://via.placeholder.com/800x400/FF3A00/FFFFFF?text=Analysis+3';
const analysisImage4 = 'https://via.placeholder.com/800x400/FF3A00/FFFFFF?text=Analysis+4';
const chartImage = 'https://via.placeholder.com/800x600/FF3A00/FFFFFF?text=Chart';
```

Then copy the full component code from the current `/src/app/pages/home-page.tsx` file.
...
**Note:** This file is quite large. Copy from the current project file at `/src/app/pages/sql-studio-page.tsx`.

The file includes:
- Landing page view with query search
- Monaco Editor integration
- Query history and catalog sidebar
...
Continue to CODE_5_PAGES_PART2.md for remaining page components.
