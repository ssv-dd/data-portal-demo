...
const DEFAULT_SQL = `-- Revenue by region and product
SELECT
  r.region_name,
  p.product_name,
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {filteredQueries.length > 0 ? (
              ...
              <div className="text-center py-16 bg-gray-50 rounded-lg">
                ...
                <Button style={{ backgroundColor: '#FF3A00' }} className="text-white gap-2" onClick={() => setShowLanding(false)}>
                  <Plus className="w-4 h-4" />
          ...
          <div className="flex-1 flex flex-col overflow-hidden bg-white">
            ...
            <div className="px-4 py-2 border-b border-gray-200 bg-amber-50">
              <div className="flex items-center gap-3 text-xs">
                ...
                <button className="ml-auto text-xs font-medium hover:underline" style={{ color: '#FF3A00' }}>
            ...
            <div className="flex items-center px-4 py-0 border-b border-gray-200">
              ...
              <div className="ml-auto flex items-center gap-2">
                ...
                <Button
                  size="sm"
                  className="text-white gap-1.5 text-xs h-7"
                  style={{ backgroundColor: '#FF3A00' }}
                  onClick={handleRun}
                  disabled={isRunning}
                >
